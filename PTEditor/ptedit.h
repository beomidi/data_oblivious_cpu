...
#define PTEDIT_PAGE_BIT_SOFTW9 63
 ...
 /** Page is valid */
#define PTEDIT_PAGE_BIT_V 0
/** Page is readable */
#define PTEDIT_PAGE_BIT_R 1
/** Page is writable */
#define PTEDIT_PAGE_BIT_W 2
/** Page is executable */
#define PTEDIT_PAGE_BIT_X 3
/** Page is accessible to user mode  */
#define PTEDIT_PAGE_BIT_U 4
/** Page is global mapping  */
#define PTEDIT_PAGE_BIT_G 5
/** Page is accessed */
#define PTEDIT_PAGE_BIT_A 6
/** Page is dirty  */
#define PTEDIT_PAGE_BIT_D 7
/** Available for programmer*/
#define PTEDIT_PAGE_BIT_RSW1 8
/** Available for programmer */
#define PTEDIT_PAGE_BIT_RSW2 9
...
typedef struct {
    ...
    size_t writeable : 1;
    size_t executable : 1;
    size_t user_accessible : 1;
    size_t global_mapping : 1;
    size_t accessed : 1;
    size_t dirty : 1;
    size_t rsw : 2;
    size_t pfn : 44;
